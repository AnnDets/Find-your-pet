...
public class CompFind {
	public static void main(String[] args) throws InterruptedException {
		...
		labelFind.setText("Я нашёл");
		labelFind.setFont(font1);
		labelFind.setForeground(Color.BLACK);
		...
		panel3231.setPreferredSize(new Dimension(1165, 70));
		JPanel panel3232 = new JPanel();
		panel3232.setBackground(new Color(250, 232, 184));
		panel3232.setPreferredSize(new Dimension(65, 70));
		//Надпись "Животное"
		...
		panel3241.setPreferredSize(new Dimension(1040, 70));
		JPanel panel3242 = new JPanel();
		panel3242.setBackground(new Color(250, 232, 184));
		panel3242.setPreferredSize(new Dimension(190, 70));
		//Надпись "Пол"
		...
		panel51.setPreferredSize(new Dimension(1320, 80));
		JPanel panel52 = new JPanel();
		panel52.setBackground(new Color(250, 232, 184));
		panel52.setPreferredSize(new Dimension(330, 80));
