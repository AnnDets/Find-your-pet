...
- **WebSocket/HTTPServlet**: Взаимодействие с клиентом для передачи данных.
...
# Инструкция по организации сетевого взаимодействия с использованием Radmin VPN

### Основные принципы работы Radmin VPN

Radmin VPN позволяет создавать виртуальные частные сети (VPN), соединяя удалённые устройства так, словно они находятся в одной локальной сети.

### Как подключиться:
1. Установите Radmin VPN
2. Присоединитесь к сети Find-your-pet (пароль не скажу).'
3. Удостоверьтесь что в строке адреса, введен IP пользователя с именем Find-your-pet-HOST.
4. Вы подключены
